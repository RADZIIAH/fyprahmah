...
import 'package:fyprahmah/payment.dart';
...
class RestaurantListScreen extends StatelessWidget {
  final List<Map<String, String>> restaurants = [
    {'name': 'Gerai MPD No.8 - SURA GATE ', 'imagePath': 'assets/images/mpd.jpg'},
    {'name': 'RR NASI KERABU HOUSE (KAK YAH NASI KERABU) - BATU 5', 'imagePath': 'assets/images/kerabu.jpg'},
    {'name': 'ANEKA SUP MIEZAN - PAKA ', 'imagePath': 'assets/images/mizan.jpg'},
  ];
